...
% to hide, comment these three and uncomment the ones below
\newcommand{\vcomment}[1]{\textbf{\textcolor{Blue}{[#1]}}}
\newcommand{\vtodo}[1]{\textbf{\textcolor{Red}{[TODO:\;#1]}}}
\newcommand{\vcleanup}[1]{\textbf{\textcolor{Orchid}{[CLEANUP:\;#1]}}}

%uncomment these and comment the ones above to get rid of the notations
