\documentclass[]{csulb-thesis-old}
...
\usepackage{minitoc}
%\usepackage{booktabs} % requires for pandas.DataTable.to_latex()
% for listings?
...
\newcommand{\Vmax}{\ensuremath{\mathcal{V}_{\max}}}
\newcommand{\VSigma}{\ensuremath{\mathcal{V}_{\Sigma}}}
\newcommand{\Vsigma}{\ensuremath{\mathcal{V}_{\sigma}}}

\newcommand{\VSigmapos}{\ensuremath{\mathcal{V}_{\Sigma}^{(+)}}}
\newcommand{\VSigmaneg}{\ensuremath{\mathcal{V}_{\Sigma}^{(-)}}}

\newcommand{\Vmaxpos}{\ensuremath{\mathcal{V}^{(+)}_{\max}}}
\newcommand{\Vmaxneg}{\ensuremath{\mathcal{V}^{(-)}_{\max}}}
...
% I can't figure out how to cref these weird 'myappendix' sections the way I want to.
