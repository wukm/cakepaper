...
\subsection{Axioms}
	Require existence of a continuous scale parameter.
	
	Require linear shift-invariant smoothing. Shift invariant means that no position in the original signal is favored (makes sense, this should apply to any image.)
