...
The ultimate choice of these parameters $\beta$ and $\gamma$ have the overall effect of tuning the selectivity of the Frangi filter itself. In the figures in %\cref{appendix-extra-frangi-figures}
the second appendix, we plot the Frangi vesselness measure itself as a function of $S$ and $A$, while sweep through different choices of $\beta$ and $\gamma$. 
