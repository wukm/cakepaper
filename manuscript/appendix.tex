...
\lstinputlisting[language=python]{compare_parameters_alt.py}
...
\lstinputlisting[language=python]{margin_add.py}
...
\lstinputlisting[language=python]{threshold_demo.py}
