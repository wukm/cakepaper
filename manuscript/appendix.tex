...
%\listinputlisting[language=python]{make_output_montage.py}
...
\lstinputlisting[language=python]{scale_sweep_demo.py}
%\lstinputlisting[language=python]{score.py}
