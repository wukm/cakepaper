...
\begin{equation}
\tilde{G} = I + [\delta], \quad  [\delta]
	:= \begin{bmatrix} h_y^2 & -h_x h_y \\
...
REPLACE BY THIS THEOREM INSTEAD:

From \cite{matrix-analysis-horn}, we can bound the perturbation of eigenvalues from $\weinmat$ to $\Hess(h)$ by
